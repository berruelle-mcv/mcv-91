...
function renderCompetencesEnseignant(){
  ...
  const _PI={'FOO-001':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/ballon-pro-match-t5.png.png','FOO-002':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/ballon-training-t4.png.png','FOO-003':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/chaussures-terrain-souple-fg.png.png','FOO-004':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/chaussure-futsal-ic.png.png','FOO-005':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/maillot-club-personnalisable.png.png','FOO-006':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/short-match-assorti.png.png','FOO-007':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/chasuble-training-x10.png.png','FOO-008':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/football/ballon-gardien-gk.png.png','BAS-001':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/ballon-officiel-t7.png','BAS-002':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/ballon-outdoor-t7.png','BAS-003':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/sneakers-low-top.png','BAS-004':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/sneakers-high-top.png','BAS-005':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/maillot-reversible-club.png','BAS-006':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/short-basket-performance.png','BAS-007':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/sac-de-sport-urbain-30l.png','BAS-008':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/basketball/chaussettes-grip-x3.png','RUN-001':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/chaussures-route-velocity.png','RUN-002':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/chaussures-trail-grip-x.png','RUN-003':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/chaussures-debutant-easyrun.png','RUN-004':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/montre-gps-run-watch.png','RUN-005':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/t-shirt-technique-dri-fit.png','RUN-006':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/veste-coupe-vent-legere.png','RUN-007':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/brassard-smartphone.png','RUN-008':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Running/ceinture-porte-bidon-2x250ml.png','FIT-001':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/halteres-neoprene-2x2kg.png','FIT-002':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/halteres-fonte-2x5kg.png','FIT-003':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/tapis-yoga-6mm.png','FIT-004':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/bandes-elastiques-set-x5.png','FIT-005':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/foam-roller-massage-45cm.png','FIT-006':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/corde-a-sauter-pro.png','FIT-007':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/gourde-isotherme-750ml.png','FIT-008':'https://raw.githubusercontent.com/berruelle-mcv/mcv-91/main/img/Fitness/legging-compression.png'};
  ...
  const compsHtml=(p.comp_ids||[]).slice(0,3).map(function(cid){
    ...
    const cpImg = _PI[cp.id]||'';
    return '<div onclick="openProduit(\''+cp.id+'\')" style="display:flex;align-items:center;gap:10px;padding:8px;border:1px solid #E5E7EB;border-radius:10px;cursor:pointer;background:#fff" onmouseover="this.style.borderColor=\'#185FA5\'" onmouseout="this.style.borderColor=\'#E5E7EB\'">'
      +'<div style="width:44px;height:36px;background:#F8FAFC;border-radius:6px;overflow:hidden;flex-shrink:0">'
      +(cpImg ? '<img src="'+cpImg+'" style="width:100%;height:100%;object-fit:cover">' : '<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:20px">'+cpC.emoji+'</div>')
      +'</div>'
  ...
  fiche.innerHTML='<div style="border-radius:14px;overflow:hidden;background:#fff;box-shadow:0 4px 24px rgba(0,0,0,.08);border:1px solid #E8EDF5">'
    ...
    +'<div style="width:200px;flex-shrink:0;background:#F8FAFC;position:relative;overflow:hidden">'
    +(pImg ? '<img src="'+pImg+'" alt="'+p.nom+'" style="width:100%;height:100%;object-fit:cover" onerror="this.style.display=\'none\'">' : '<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:60px">'+c.emoji+'</div>')
